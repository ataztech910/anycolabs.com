...
1. Регистрация и авторизация в сервисе :pencil: 
2. Создание группы или проекта для обсуждения :tomato:
3. Создание самой ветки обсуждения :tomato:
4. Рисование на экране (это под вопросом. Нужно понять как унифицировать разрешение для группы обсуждающих) :tomato:
5. Эмоджи :tomato:
6. Гифки :tomato:
7. Создание задачи (задача это группа для обсуждения со статусом) :tomato:
8. Создание публичного обсуждения, без привязки к закрытым группам и проектам :tomato:
9. Возможность создавать публичные и приватные задачи :tomato:
